...
${OBJECTDIR}/LogicGame/Level.o: LogicGame/Level.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LogicGame/Level.o LogicGame/Level.cpp

${OBJECTDIR}/LogicGame/LogicGame.o: LogicGame/LogicGame.cpp 
	${MKDIR} -p ${OBJECTDIR}/LogicGame
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LogicGame/LogicGame.o LogicGame/LogicGame.cpp

${OBJECTDIR}/LogicGame/LogicPlaything.o: LogicGame/LogicPlaything.cpp 
	${MKDIR} -p ${OBJECTDIR}/LogicGame
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LogicGame/LogicPlaything.o LogicGame/LogicPlaything.cpp

${OBJECTDIR}/LogicGame/LogicalNodes.o: LogicGame/LogicalNodes.cpp 
	${MKDIR} -p ${OBJECTDIR}/LogicGame
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LogicGame/LogicalNodes.o LogicGame/LogicalNodes.cpp

${OBJECTDIR}/LogicGame/RandomLineTaker.o: LogicGame/RandomLineTaker.cpp 
	${MKDIR} -p ${OBJECTDIR}/LogicGame
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LogicGame/RandomLineTaker.o LogicGame/RandomLineTaker.cpp

${OBJECTDIR}/LogicGame/RandomLines.o: LogicGame/RandomLines.cpp 
	${MKDIR} -p ${OBJECTDIR}/LogicGame
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LogicGame/RandomLines.o LogicGame/RandomLines.cpp

${OBJECTDIR}/LogicalSentence.o: LogicalSentence.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LogicalSentence.o LogicalSentence.cpp
...
${OBJECTDIR}/TrinaryLogic.o: TrinaryLogic.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TrinaryLogic.o TrinaryLogic.cpp
